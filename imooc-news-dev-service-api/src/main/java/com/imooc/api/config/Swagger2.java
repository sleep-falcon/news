...
//    http://localhost:8088/doc.html     新路径(better)
    ...
    public Docket createRestApi() {
        ...
        Predicate<RequestHandler> articleHTMLPredicate = RequestHandlerSelectors.basePackage("com.imooc.article.html.controller");
        ...
        return new Docket(DocumentationType.SWAGGER_2)  // 指定api类型为swagger2
                ...
                .select()
                .apis(Predicates.or(adminPredicate, articlePredicate, userPredicate, filesPredicate,articleHTMLPredicate))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .contact(new Contact("yly",
                        "https://www.baidu.com",
                        "3327317060@qq.com"))                   // 联系人信息
